...
relais1 = machine.Pin(29, machine.Pin.OUT)
relais2 = machine.Pin(26, machine.Pin.OUT)
relais3 = machine.Pin(30, machine.Pin.OUT)
relais4 = machine.Pin(25, machine.Pin.OUT)
relais1.value(0)
relais3.value(0)
relais2.value(0)
relais4.value(0)
...
def configure_mqtt_client():
    client = robust.MQTTClient("SB", "xxx", xxx, "xxx", "xxx")
    client.connect()
